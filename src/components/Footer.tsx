treimport { Link } from "react-router-dom";
    ...
    <footer className="bg-white border-t mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-black text-centre">Semilogo</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-black text-centre">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-black text-centre">Connect</h3>
